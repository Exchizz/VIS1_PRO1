...
//    cv::filter2D(InputSrc, afterKernel, CV_32F, kernel, cv::Point(-1,-1), 0.0, cv::BORDER_REPLICATE);
    cv::filter2D(InputSrc, afterKernel, CV_32F, kernel);
...
/*
	magnitudeInput:  magnitude generated by DFT
	phaseInput: phase generated by DFT, not used though
	notch_centers: vector of points to place notches
